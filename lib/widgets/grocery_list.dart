...
class _GroceryListState extends State<GroceryList> {
  ...
  void _loadItems() async {
    final url = Uri.https(
        'shoppinglist-15fe2-default-rtdb.firebaseio.com', 'shopping-list.json');
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLoading) {
      // So it wont show 'No items..' while still loading
          ...
          child: ListTile(
            ...
            leading: Container(
              ...
              child: Icon(
                ...
                color: Colors.white, // or any other suitable color
